				...
				<div id="courses-wrapper" >
					...
					<div class="row" >
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="https://www.amazon.in/Web-Design-Playground-Paul-McFedries/dp/1617294403" target="_blank" class="course-img">
									<img src="./img/Web_Design.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="https://www.amazon.in/Web-Design-Playground-Paul-McFedries/dp/1617294403" target="_blank" style="font-size:18px; text-align: center">Web Design Playground: HTML & CSS the Interactive Way</a>
								<div class="course-details" style="margin:5px;">
									<span class="course-category">Web Development</span>
									<span class="course-price course-free">₹4,414.00</span>
								</div>
							</div>
						</div>
						<!-- /single course -->
